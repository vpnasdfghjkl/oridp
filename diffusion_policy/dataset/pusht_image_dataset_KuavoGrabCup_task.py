...
class PushTImageDataset(BaseImageDataset):
    def __init__(self,
        ...
        self.replay_buffer = ReplayBuffer.copy_from_path(
            zarr_path, keys=['img01', 'img02', 'img03', 'state_joint_with_hand', 'cmd_joint_with_hand'])
    ...
    def get_normalizer(self, mode='limits', **kwargs):
        ...
        normalizer['img03'] = get_image_range_normalizer()
        return normalizer
    ...
    def _sample_to_data(self, sample):
        ...
        img03 = np.moveaxis(sample['img03'],-1,1)/255
